...
describe('ModelComponent', () => {
  ...
  const wrapper = shallowMount(OverviewModelComponent, {
    ...
    it('delete function should call delete on parent component', () => {
      ...
      // Assert
      wrapper.vm.$nextTick(() => {expect(wrapper.vm.$parent.deleteModel).toHaveBeenCalledWith("testmodelId");});
    } );
    ...
    it('execute function should call execute on parent component', () => {
      ...
      // Act
      wrapper.vm.executeModel("testtableName", "testmodelId", "testRecord1", "testRecord2");

      // Assert
      expect(wrapper.vm.$parent.executeModel).toHaveBeenCalledWith("testtableName", "testmodelId", "testRecord1", "testRecord2");
